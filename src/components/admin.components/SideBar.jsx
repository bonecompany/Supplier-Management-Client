...
const Sidebar = () => {
  return (
    ...
    <aside  className="fixed top-0 left-0 z-40 max-sm:w-10 w-64 h-screen pt-5 transition-transform  bg-white border-r border-gray-200 translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">

      <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <a href="https://flowbite.com/" class="flex items-center ps-2.5 mb-4">
         <img src={logoImg} class="h-10 w-36 me-3 sm:h-12" alt="Flowbite Logo" />
