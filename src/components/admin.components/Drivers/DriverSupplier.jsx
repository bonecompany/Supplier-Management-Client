        ...
        <div className="flex justify-center">
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-4">
            {mapData?.map((ele, ind) => (
              <div
                key={ind}
                className="w-full max-w-xs h-fit max-h-28 bg-gradient-to-r from-[#303a52] to-[#13284d] cursor-pointer 
                rounded-md shadow-[#0f131e] text-white overflow-hidden transition-all duration-300 ease-in-out 
