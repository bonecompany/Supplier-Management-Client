...
import AdminNavbar from "./AdminNavbar";
import { Outlet, useNavigate } from "react-router-dom";
import BottomNavbar from "./BottomNavbar"; // Import the new bottom navbar
  ...
  return (
    <div className="flex h-screen flex-col ">
      ...
      <div className="flex h-full pt-[72px]">
        ...
        <aside
          className={`hidden lg:flex flex-col ${isExpanded ? "w-64 px-2" : "w-16"
            } bg-gradient-to-b from-[#303b53] to-[#172131] text-white h-full transition-width duration-200 shadow-lg`}
        >
          <nav className="flex flex-col justify-between flex-1">
            <div className="flex flex-col space-y-2 mt-4 px-1">
        ...
        <BottomNavbar isMenu={isMenu} setIsMenu={setIsMenu} />
